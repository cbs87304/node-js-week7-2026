...
-- 工單 2：企業會員的課表
CREATE INDEX IF NOT EXISTS idx_course_bookings_user_id_cancelled_at
ON course_bookings(user_id, cancelled_at);

-- 工單 3：最新購買紀錄牆
CREATE INDEX IF NOT EXISTS idx_credit_purchases_order
...
CREATE INDEX IF NOT EXISTS idx_course_bookings_user_id_active
